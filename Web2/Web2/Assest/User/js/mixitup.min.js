...
!function (t) {
    ...
    !function () {
                ...
                Object.keys = function () {
                    ...
                    return e = !{
                        ...
                        function (i) {
                            ...
                            for (r in i) t.call(i, r) &&
                                o.push(r);
                            if (e) for (s = 0; s < a; s++) t.call(i, n[s]) &&
                                o.push(n[s]);
                            return o
                        }
                }()
        ...
        e = function (a, i, o) {
            ...
            else if (a && 'object' == typeof a && n.isElement(a, u)) m = [
                a
            ];
            else {
            ...
            for (g = 0; (r = m[g]) && (!(g > 0) || s); g++) r.id ? d = r.id : (d = 'MixItUp' + n.randomHex(), r.id = d),
                ...
                i &&
                    i.debug &&
                    i.debug.enable ? h.push(l) : h.push(c);
            return f = s ? new e.Collection(h) : h[0]
        },
        e.use = function (t) {
            e.Base.prototype.callActions.call(e, 'beforeUse', arguments),
                'function' == typeof t &&
                    'mixitup-extension' === t.TYPE ? 'undefined' == typeof e.extensions[t.NAME] &&
                (t(e), e.extensions[t.NAME] = t) : t.fn &&
                t.fn.jquery &&
                (e.libraries.$ = t),
        ...
        n = {
            ...
            extend: function (t, e, n, a) {
                ...
                try {
                    ...
                    for (r = 0; r < i.length; r++) o = i[r],
                        !n ||
                            'object' != typeof e[o] ||
                            this.isElement(e[o]) ? t[o] = e[o] : Array.isArray(e[o]) ? (t[o] || (t[o] = []), this.extend(t[o], e[o], n, a)) : (t[o] || (t[o] = {}), this.extend(t[o], e[o], n, a))
                } catch (s) {
                    if (!a) throw s;
            ...
            on: function (e, n, a, i) {
                e &&
                    (
                        e.addEventListener ? e.addEventListener(n, a, i) : e.attachEvent &&
                            (
                                e['e' + n + a] = a,
                                e[n + a] = function () {
                                    e['e' + n + a](t.event)
            ...
            off: function (t, e, n) {
                t &&
                    (
                        t.removeEventListener ? t.removeEventListener(e, n, !1) : t.detachEvent &&
            ...
            getCustomEvent: function (e, n, a) {
                ...
                return a = a ||
                    ...
                    'function' == typeof t.CustomEvent ? i = new t.CustomEvent(e, {
                        ...
                        bubbles: !0,
                        cancelable: !0
                    }) : 'function' == typeof a.createEvent ? (i = a.createEvent('CustomEvent'), i.initCustomEvent(e, !0, !0, n)) : (
            ...
            getOriginalEvent: function (t) {
                return t.touches &&
                    t.touches.length ? t.touches[0] : t.changedTouches &&
                        t.changedTouches.length ? t.changedTouches[0] : t
            },
            index: function (t, e) {
                for (var n = 0; null !== (t = t.previousElementSibling);) e &&
                    !t.matches(e) ||
                    ++n;
                return n
            },
            ...
            position: function (t) {
                for (var e = 0, n = 0, a = t; t;) e -= t.scrollLeft,
                    n -= t.scrollTop,
                    t === a &&
            ...
            all: function (n, a) {
                var i = null;
                return e.features.has.promises ? Promise.all(n) : (i = t.jQuery || a.$) &&
                    'function' == typeof i.when ? i.when.apply(i, n).done(function () {
                        return arguments
                    }) : (
                    t.console &&
                    console.warn(e.messages.warningNoPromiseImplementation()),
            ...
            e.Control.prototype,
            {
                ...
                handleClick: function (t) {
                    ...
                    switch (a.type) {
                        case 'filter':
                            l.filter = a.filter ||
                                i.getAttribute('data-filter');
                            break;
                        case 'sort':
                            l.sort = a.sort ||
                                i.getAttribute('data-sort');
                            break;
                        case 'multimix':
                            l.filter = a.filter ||
                                i.getAttribute('data-filter'),
                ...
                update: function (t, n) {
                    ...
                    a.callActions('beforeUpdate', arguments),
                        ...
                        a.pending > 0 ||
                        (
                            'live' === a.status ? a.updateLive(t, n) : (
                                i.sort = a.sort,
                                i.filter = a.filter,
                    ...
                    switch (i.callActions('beforeParseStatusChange', arguments), i.type) {
                        ...
                        case 'sort':
                            e.sort.match(/:asc/g) &&
                                ...
                                e.sort === n.sort ||
                                    o === n.sort ? i.renderStatus(t, 'active') : i.renderStatus(t, 'inactive');
                            break;
                        case 'toggle':
                            for (
                                a.length < 1 &&
            ...
            e.Mixer.prototype,
            {
                ...
                attach: function (a, i, o, r) {
                    ...
                    for (
                        ...
                        s.config.data.uidKey &&
                        (s.config.controls.enable = !1),
                        s.indexTargets(),
                ...
                getInitialState: function () {
                    ...
                    if (
                        ...
                        a.startContainerClassName = a.newContainerClassName = n.activeContainerClassName,
                        'all' === a.newFilter.selector ? a.newFilter.selector = t.config.selectors.target : 'none' === a.newFilter.selector &&
                ...
                splitCompoundSelector: function (t) {
                    var e = t.split(/([\.\[])/g),
                        ...
                        a = '',
                        i = - 1;
                    for ('' === e[0] && e.shift(), i = 0; i < e.length; i++) i % 2 === 0 &&
                        (a = ''),
                        a += e[i],
                        i % 2 !== 0 &&
                        n.push(a);
                ...
                getNextSibling: function (t, e, n) {
                    ...
                    return t = Math.max(t, 0),
                        e &&
                            'before' === n ? i = e : e &&
                                'after' === n ? i = e.nextElementSibling ||
                                null : a.targets.length > 0 &&
                                    'undefined' != typeof t ? i = t < a.targets.length ||
                                        !a.targets.length ? a.targets[t].dom.el : a.targets[a.targets.length - 1].dom.el.nextElementSibling : 0 === a.targets.length &&
                ...
                filterOperation: function (t) {
                    ...
                    for (
                        ...
                        o = t.newOrder[r];
                        r++
                    ) n = t.newFilter.collection ? t.newFilter.collection.indexOf(o.dom.el) > - 1 : '' !== t.newFilter.selector &&
                        o.dom.el.matches(t.newFilter.selector),
                        e.evaluateHideShow(n, o, i, t);
                    if (t.toRemove.length) for (r = 0; o = t.show[r]; r++) t.toRemove.indexOf(o) > - 1 &&
                        (
                            t.show.splice(r, 1),
                ...
                evaluateHideShow: function (t, e, n, a) {
                    ...
                    o = i.callFilters('testResultEvaluateHideShow', t, r),
                        ...
                        o === !0 &&
                            'show' === n ||
                            o === !1 &&
                            'hide' === n ? (a.show.push(e), !e.isShown && a.toShow.push(e)) : (a.hide.push(e), e.isShown && a.toHide.push(e)),
                ...
                sortOperation: function (t) {
                    ...
                    if (
                        ...
                        t.newOrder = i
                    } else 'random' === t.newSort.order ? t.newOrder = n.arrayShuffle(t.startOrder) : '' === t.newSort.attribute ? (
                        t.newOrder = a.origOrder.slice(),
                        'desc' === t.newSort.order &&
                        t.newOrder.reverse()
                    ) : (
                    ...
                    n.isEqualArray(t.newOrder, t.startOrder) &&
                        (t.willSort = !1),
                ...
                compare: function (t, e, n) {
                    ...
                    return isNaN(1 * o) ||
                        isNaN(1 * r) ? (o = o.toLowerCase(), r = r.toLowerCase()) : (o = 1 * o, r = 1 * r),
                        o < r ? 'asc' === i ? - 1 : 1 : o > r ? 'asc' === i ? 1 : - 1 : o === r &&
                            n.next ? a.compare(t, e, n.next) : 0
                },
                ...
                parseEffects: function () {
                    var t = this,
                        n = '',
                        a = t.config.animation.effectsIn ||
                            t.config.animation.effects,
                        i = t.config.animation.effectsOut ||
                            t.config.animation.effects;
                    ...
                    for (n in e.transformDefaults) e.transformDefaults[n] instanceof e.TransformData &&
                        (
                ...
                parseEffect: function (t, n, a, i, o) {
                    ...
                    t
                        ...
                        default:
                            if (
                                o &&
                                    r.config.animation.reverseOut &&
                                    'scale' !== t ? a[t].value = (f ? parseFloat(f) : e.transformDefaults[t].value) * - 1 : a[t].value = f ? parseFloat(f) : e.transformDefaults[t].value,
                                f
                            ) {
                ...
                buildState: function (t) {
                    ...
                    for (o = 0; i = t.hide[o]; o++) (!t.toRemove.length || t.toRemove.indexOf(i) < 0) &&
                ...
                goMix: function (a, i) {
                    ...
                    return o.callActions('beforeGoMix', arguments),
                        ...
                        a &&
                            ...
                            o.config.debug.fauxAsync ? setTimeout(function () {
                                o.cleanUp(i)
                ...
                cleanUp: function (t) {
                    ...
                    if (
                        ...
                        for (l = 0; i = a.targets[l]; l++) t.toRemove.indexOf(i) > - 1 &&
                            (
                ...
                parseMultimixArgs: function (t) {
                    ...
                    for (
                        ...
                        null !== o &&
                        (
                            'object' == typeof o ? n.extend(i.command, o) : 'boolean' == typeof o ? i.animate = o : 'function' == typeof o &&
                                (i.callback = o)
                        );
                    return !i.command.insert ||
                ...
                parseFilterArgs: function (t) {
                    ...
                    for (
                        ...
                        'string' == typeof o ? i.command.selector = o : null === o ? i.command.collection = [] : 'object' == typeof o &&
                            n.isElement(o, a.dom.document) ? i.command.collection = [
                                o
                            ] : 'object' == typeof o &&
                                'undefined' != typeof o.length ? i.command.collection = n.arrayFromList(o) : 'object' == typeof o ? n.extend(i.command, o) : 'boolean' == typeof o ? i.animate = o : 'function' == typeof o &&
                                    (i.callback = o);
                ...
                parseInsertArgs: function (t) {
                    ...
                    for (
                        ...
                        null !== o &&
                        (
                            'number' == typeof o ? i.command.index = o : 'string' == typeof o &&
                                [
                                    'before',
                                    'after'
                                ].indexOf(o) > - 1 ? i.command.position = o : 'string' == typeof o ? i.command.collection = n.arrayFromList(n.createElement(o).childNodes) : 'object' == typeof o &&
                                    n.isElement(o, a.dom.document) ? i.command.collection.length ? i.command.sibling = o : i.command.collection = [
                                        o
                                    ] : 'object' == typeof o &&
                                        o.length ? i.command.collection.length ? i.command.sibling = o[0] : i.command.collection = o : 'object' == typeof o &&
                                            o.childNodes &&
                                            o.childNodes.length ? i.command.collection.length ? i.command.sibling = o.childNodes[0] : i.command.collection = n.arrayFromList(o.childNodes) : 'object' == typeof o ? n.extend(i.command, o) : 'boolean' == typeof o ? i.animate = o : 'function' == typeof o &&
                                                (i.callback = o)
                        );
                    if (i.command.index && i.command.sibling) throw new Error(e.messages.errorInsertInvalidArguments());
                    return !i.command.collection.length &&
                        a.config.debug.showWarnings &&
                ...
                parseRemoveArgs: function (t) {
                    ...
                    for (
                        ...
                        case 'object':
                            r &&
                                r.length ? i.command.collection = r : n.isElement(r, a.dom.document) ? i.command.collection = [
                                    r
                    ...
                    if (i.command.collection.length) for (s = 0; o = a.targets[s]; s++) i.command.collection.indexOf(o.dom.el) > - 1 &&
                        i.command.targets.push(o);
                    return !i.command.targets.length &&
                        a.config.debug.showWarnings &&
                ...
                parseDatasetArgs: function (t) {
                    ...
                    for (
                        ...
                        case 'object':
                            Array.isArray(o) ||
                                'number' == typeof o.length ? i.command.dataset = o : n.extend(i.command, o);
                            break;
                        case 'boolean':
                            i.animate = o;
                            break;
                ...
                getOperation: function (t) {
                    ...
                    return c = a.callFilters('operationUnmappedGetOperation', c, arguments),
                        ...
                        a.isBusy ? (
                            ...
                            'all' === c.newFilter.selector ? c.newFilter.selector = a.config.selectors.target : 'none' === c.newFilter.selector &&
                ...
                tween: function (t, e) {
                    ...
                    for (e = Math.min(e, 1), e = Math.max(e, 0), o = 0; n = t.show[o]; o++) a = t.showPosData[o],
                        n.applyTween(a, e);
                    for (o = 0; n = t.hide[o]; o++) n.isShown &&
                        n.hide(),
            ...
            e.Target.prototype,
            {
                ...
                init: function (t, n, a) {
                    ...
                    if (
                        ...
                        i.cacheDom(t),
                        i.bindEvents(),
                        'none' !== i.dom.el.style.display &&
                        (i.isShown = !0),
                        a &&
                        n.config.data.uidKey
                    ) {
                        if (
                ...
                render: function (t) {
                    ...
                    return s = i(t),
                        s &&
                            'object' == typeof s &&
                            n.isElement(s) ? o = s : 'string' == typeof s &&
                        (
                ...
                getDelay: function (t) {
                    var e = this,
                        n = - 1;
                    return 'function' == typeof e.mixer.config.animation.staggerSequence &&
        ...
        e.Messages.prototype.compileTemplates = function () {
            var t = '',
                e = '';
            for (t in this) 'string' == typeof (e = this[t]) &&
