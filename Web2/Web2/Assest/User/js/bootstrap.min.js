    ...
    'object' == typeof exports &&
        'undefined' != typeof module ? e(exports, require('jquery'), require('popper.js')) : 'function' == typeof define &&
            define.amd ? define(['exports',
                'jquery',
                'popper.js'], e) : e((t = t || self).bootstrap = {}, t.jQuery, t.Popper)
}(
    this,
    function (t, g, u) {
        'use strict';
        ...
        function l(o) {
            for (var t = 1; t < arguments.length; t++) {
                ...
                ) : Object.getOwnPropertyDescriptors ? Object.defineProperties(o, Object.getOwnPropertyDescriptors(r)) : e(Object(r)).forEach(
                    function (t) {
        ...
        g = g &&
            g.hasOwnProperty('default') ? g.default : g,
            u = u &&
        ...
        var _ = {
            ...
            getTransitionDurationFromElement: function (t) {
                ...
                return i ||
                    ...
                    e = e.split(',')[0],
                    n = n.split(',')[0],
                    1000 * (parseFloat(e) + parseFloat(n))
                ) : 0
            },
            reflow: function (t) {
            ...
            H = function () {
                ...
                return t.toggle = function () {
                    ...
                    if (n) {
                        ...
                        if (i) {
                            if ('radio' === i.type) if (i.checked && this._element.classList.contains(S)) t = !1;
                                ...
                                o &&
                                    g(o).removeClass(S)
                            } else 'checkbox' === i.type ? 'LABEL' === this._element.tagName &&
                    ...
                    this._element.hasAttribute('disabled') ||
                        ...
                        (
                            e &&
                            this._element.setAttribute('aria-pressed', !this._element.classList.contains(S)),
                            t &&
                ...
                function () {
                    for (
                        ...
                        var i = t[e],
                            o = i.querySelector(k);
                        o.checked ||
                            o.hasAttribute('checked') ? i.classList.add(S) : i.classList.remove(S)
                    }
                    for (
                        var r = 0,
                ...
                return t.next = function () {
                    ...
                    t._addEventListeners = function () {
                        ...
                        this._config.keyboard &&
                            ...
                            g(this._element).on(Y.MOUSEENTER, function (t) {
                                return e.pause(t)
                    ...
                    t._addTouchEventListeners = function () {
                        ...
                        if (this._touchSupported) {
                            var n = function (t) {
                                e._pointerEvent &&
                                    ht[t.originalEvent.pointerType.toUpperCase()] ? e.touchStartX = t.originalEvent.clientX : e._pointerEvent ||
                                        ...
                                        function (t) {
                                            return function (t) {
                                                t.originalEvent.touches &&
                                                    1 < t.originalEvent.touches.length ? e.touchDeltaX = 0 : e.touchDeltaX = t.originalEvent.touches[0].clientX - e.touchStartX
                                            }(t)
                                        }
                                    ),
                    ...
                    t._getItemIndex = function (t) {
                        return this._items = t &&
                            t.parentNode ? [].slice.call(t.parentNode.querySelectorAll(ot)) : [],
                    ...
                    t.show = function () {
                        ...
                        if (
                            ...
                            (
                                this._parent &&
                                0 === (
                                    t = [].slice.call(this._parent.querySelectorAll(Dt)).filter(
                                        function (t) {
                            ...
                            if (g(this._element).trigger(e), !e.isDefaultPrevented()) {
                                ...
                                if (0 < i) for (var o = 0; o < i; o++) {
                                    var r = this._triggerArray[o],
                                        s = _.getSelectorFromElement(r);
                                    if (null !== s) g([].slice.call(document.querySelectorAll(s))).hasClass(yt) ||
                ...
                return t.toggle = function () {
                        ...
                        if (
                            ...
                            if (g(i).trigger(n), !n.isDefaultPrevented()) {
                                if (!this._inNavbar && t) {
                                    ...
                                    var o = this._element;
                                    'parent' === this._config.reference ? o = i : _.isElement(this._config.reference) &&
                                        (
                    ...
                    t._getPlacement = function () {
                        var t = g(this._element.parentNode),
                            e = Xt;
                        return t.hasClass(xt) ? (e = Yt, g(this._menu).hasClass(Wt) && (e = zt)) : t.hasClass(Ft) ? e = Gt : t.hasClass(Ut) ? e = Jt : g(this._menu).hasClass(Wt) &&
                            (e = $t),
                            e
                    },
                    ...
                    c._jQueryInterface = function (e) {
                        return this.each(
                            function () {
                                ...
                                if (
                                    t ||
                                    (t = new c(this, 'object' == typeof e ? e : null), g(this).data(Nt, t)),
                                    'string' == typeof e
                                ) {
        ...
        g(document).on(jt.KEYDOWN_DATA_API, Mt, ee._dataApiKeydownHandler).on(jt.KEYDOWN_DATA_API, Qt, ee._dataApiKeydownHandler).on(jt.CLICK_DATA_API + ' ' + jt.KEYUP_DATA_API, ee._clearMenus).on(
            jt.CLICK_DATA_API,
            Mt,
            function (t) {
                t.preventDefault(),
                ...
                return t.toggle = function (t) {
                    ...
                    t._showElement = function (t) {
                        ...
                        this._element.parentNode &&
                            ...
                            g(this._dialog).hasClass(ce) &&
                                i ? i.scrollTop = 0 : this._element.scrollTop = 0,
                            n &&
                            _.reflow(this._element),
                    ...
                    t._setEscapeEvent = function () {
                        var e = this;
                        this._isShown &&
                            this._config.keyboard ? g(this._element).on(
                                le.KEYDOWN_DISMISS,
                                function (t) {
                                    27 === t.which &&
            ...
            Xe = function () {
                ...
                return t.enable = function () {
                    ...
                    t.setElementContent = function (t, e) {
                        'object' != typeof e ||
                            !e.nodeType &&
                            !e.jquery ? this.config.html ? (
                                this.config.sanitize &&
                                (e = we(e, this.config.whiteList, this.config.sanitizeFn)),
                                t.html(e)
                            ) : t.text(e) : this.config.html ? g(e).parent().is(t) ||
                    ...
                    t._enter = function (t, e) {
                        ...
                        (e = e || g(t.currentTarget).data(n)) ||
                            ...
                            t &&
                            (e._activeTrigger['focusin' === t.type ? Ve : Be] = !0),
                            g(e.getTipElement()).hasClass(Me) ||
                                e._hoverState === Fe ? e._hoverState = Fe : (
                                clearTimeout(e._timeout),
                                e._hoverState = Fe,
                                e.config.delay &&
                                    e.config.delay.show ? e._timeout = setTimeout(function () {
                                        e._hoverState === Fe &&
                                            e.show()
                    ...
                    t._leave = function (t, e) {
                        ...
                        (e = e || g(t.currentTarget).data(n)) ||
                            ...
                            t &&
                            (e._activeTrigger['focusout' === t.type ? Ve : Be] = !1),
                            e._isWithActiveTrigger() ||
                            (
                                clearTimeout(e._timeout),
                                e._hoverState = Ue,
                                e.config.delay &&
                                    e.config.delay.hide ? e._timeout = setTimeout(function () {
                                        e._hoverState === Ue &&
                                            e.hide()
                ...
                return t.refresh = function () {
                    ...
                    t._getConfig = function (t) {
                        if (
                            ...
                            e ||
                                (e = _.getUID(un), g(t.target).attr('id', e)),
                                t.target = '#' + e
                        }
                    ...
                    t._activate = function (e) {
                        ...
                        n.hasClass(vn) ? (n.closest(Dn).find(wn).addClass(yn), n.addClass(yn)) : (
                            n.addClass(yn),
                    ...
                    t._activate = function (t, e, n) {
                        ...
                        var o = this,
                            r = (
                                !e ||
                                    'UL' !== e.nodeName &&
                                    'OL' !== e.nodeName ? g(e).children(Mn) : g(e).find(Kn)
                            )[0],
                            s = n &&
                                r &&
                                g(r).hasClass(Fn);
